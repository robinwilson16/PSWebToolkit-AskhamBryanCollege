...
<div class="bd-callout bd-callout-askham bd-callout-grey PrivacyNotice">
    ...
    <p>These are available on the College web site <a href="https://www.askham-bryan.ac.uk/publication-scheme-admissions/" target="_blank" rel="noopener">https://www.askham-bryan.ac.uk/publication-scheme-admissions/</a> and at <a href="https://www.askham-bryan.ac.uk/publication-scheme-higher-education/" target="_blank" rel="noopener">https://www.askham-bryan.ac.uk/publication-scheme-higher-education/</a> or by request from Student Records. You understand they include important information about our rights to vary the contract with you, our liability to you and our rights to terminate the contract with you.</p>
    ...
    <ul>
        ...
        <li>You have been made aware of the College policies <a href="https://www.askham-bryan.ac.uk/college-policies/" target="_blank" rel="noopener">https://www.askham-bryan.ac.uk/college-policies/</a> and at <a href="https://www.askham-bryan.ac.uk/publication-scheme-higher-education/" target="_blank" rel="noopener">https://www.askham-bryan.ac.uk/publication-scheme-higher-education/</a>.</li>
...
<div class="bd-callout bd-callout-askham bd-callout-grey">
    ...
    <div class="form-input">
        <p><strong>Please tick to acknowledge the above statements:</strong></p>
    ...
    <div class="row gap-3">
        <div class="col-md">
            <span class="d-grid gap-2 d-md-block">
                ...
                <cc1:CCCButton ID="btnBack" LinkResource="checkout_photo_HE_aspx" CssClass="d-none" class="d-none" ClientIDMode="Static" runat="server" Text="Back" ImageResource="btnBack" CausesValidation="false" />
            </span>
        </div>
