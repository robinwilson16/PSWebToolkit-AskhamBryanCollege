...
Partial Class webcontrols_checkout_enquiriesGUIDES
    ...
    Public Overrides Sub ValidateControl()
        ...
        'If copiesof.SelectedValue = "" Then

        '    Dim v As New CustomValidator
        '    v.IsValid = False
        '    v.ErrorMessage = "Which guides would you like a copy of?"
        '    Me.Page.Validators.Add(v)
    ...
    Protected Sub btnContinue_click(ByVal sender As Object, ByVal e As EventArgs) Handles btnContinue.Click
        ...
        If Me.Page.IsValid Then
            ...
            If Not copiesof.SelectedValue = "" Then

                For Each item As ListItem In copiesof.Items

                    If item.Selected Then

                        WorkingData.EnquiryRequestRow.EnquiryUserDefined3 = WorkingData.EnquiryRequestRow.EnquiryUserDefined3 + " , " + item.Text
            ...
            WorkingData.EnquiryRequestRow.Address1 = CStr(txtAddress1.Value)
                WorkingData.EnquiryRequestRow.Address2 = CStr(txtAddress2.Value)
                WorkingData.EnquiryRequestRow.Address3 = CStr(txtAddress3.Value)
                WorkingData.EnquiryRequestRow.Address4 = CStr(txtAddress4.Value)
