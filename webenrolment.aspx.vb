...
Partial Class webcontrols_webenrolment
    ...
    Protected Sub master_Page_PreLoad(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If Not pageURL.Contains("courseapply.ascx") And Not pageURL.Contains("courseenrol.ascx") And Not pageURL.Contains("check_applicant.ascx") And Not pageURL.Contains("check_learner.ascx") And Not pageURL.Contains("checkout_enrolFC.ascx") And Not pageURL.Contains("thankyou_application.ascx") And Not pageURL.Contains("thankyou.ascx") And WorkingData.ShoppingCart.Items.Count = 0 Then
            hasExpired = True
            ...
            Dim errorMsg As String = " " _
                        & "<div class=""alert alert-danger"" role=""alert"">" _
                            ...
                            & "<p>Sorry the form has timed out as it must be completed within 40 minutes.</p>" _
                            & "<p>You will need to complete your application request again.</p>" _
                            & "<hr>" _
                            & "<div class=""row mb-0"">" _
                                & "<div class=""col-md text-center"">" _
                                    & "<button type=""submit"" class=""btn btn-danger"">Return To The Askham-Bryan Website</button>" _
                                & "</div>" _
                            & "</div>" _
                        & "</div>"
