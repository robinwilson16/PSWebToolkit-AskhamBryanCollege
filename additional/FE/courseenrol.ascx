...
'Dim OfferingRow = OfferingDataTable.FetchByOfferingID(crs.OfferingID)
    ...
    <div class="bd-callout bd-callout-warning">
        <h5 class="mb-4">
            <kbd>FE Form</kbd> Before you begin please have with you:
        </h5>
        ...
        <div class="row gap-3">
            ...
            <div class="col-md text-end">
                <span class="d-grid gap-2 d-md-block">
                    ...
                    <cc1:CCCButton ID="btnContinue" CssClass="d-none" class="d-none" ClientIDMode="Static" runat="server" Text="Continue to Checkout" ImageResource="btnContinue" LinkResource="checkout_enrolments_FE_aspx" CausesValidation="true" />
                </span>
            </div>
        </div>
    </div>

<%--<cc1:CCCButton ID="btnContinue6" runat="server" Text="Start " CssClass="button" LinkResource="checkout_enrolments_FE_aspx" />--%>
