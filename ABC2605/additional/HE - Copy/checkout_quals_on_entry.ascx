...
<cc1:CCCButton ID="btnContinue" runat="server" Text="Continue" CssClass="button" LinkResource="checkout_employment_HE_aspx" CausesValidation="true" EnableEnterKey="true" />
<br />
