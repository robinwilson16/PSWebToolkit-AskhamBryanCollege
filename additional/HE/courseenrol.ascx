        ...
        <%--<div class="table-responsive">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="courselistgrid table table-striped table-bordered text-center"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TotalFeeAmount" HeaderText="Home Fee Per Year" DataFormatString="{0:c}" Visible="true">
                        <ControlStyle CssClass="searchgridfield" />
                    </asp:BoundField>
                    <asp:BoundField DataField="GrossTuitionFeeOverride" HeaderText="Oversees Fee Per Year" DataFormatString="{0:c}" Visible="true">
                        <ControlStyle CssClass="searchgridfield" />
                    </asp:BoundField>
                </Columns>
...
'Dim OfferingRow = OfferingDataTable.FetchByOfferingID(crs.OfferingID)
    ...
    <div class="bd-callout bd-callout-warning">
        <h5 class="mb-4">
            <kbd>HE Form</kbd> Before you begin please have with you:
        </h5>
...
<%--<cc1:CCCButton ID="btnContinue6" runat="server" Text="Start " CssClass="button" LinkResource="checkout_enrolments_he_aspx" />--%>
