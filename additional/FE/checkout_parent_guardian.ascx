...
<div class="bd-callout bd-callout-askham bd-callout-grey">
  ...
  <div class="row">
    ...
    <div class="row">
     ...
     <div class="row">
        <div class="col-sm-6 columns form-group">
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="ParentEmailAddress" HTML5InputType="email" ID="fldEmail" runat="server" IsRequired="true" LabelWidth="200" CustomCaption="Email Address" />
        </div>
         <div class="col-sm-6 columns form-group">
