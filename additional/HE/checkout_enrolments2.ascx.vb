...
Partial Class webcontrols_checkout_enrolments2
    ...
    Protected Overrides Sub OnLoad(e As EventArgs)
        ...
        If Not IsPostBack Then
            ...
            If WorkingData.EnrolmentRequestRow.ServedInArmedForces = True Then
                fldServedInArmedForces.SelectedValue = "Yes"
            ElseIf WorkingData.EnrolmentRequestRow.ServedInArmedForces = False Then
                fldServedInArmedForces.SelectedValue = "No"
            End If
        End If
    ...
    Public Overrides Sub ValidateControl()
        ...
        If fldServedInArmedForces.SelectedValue = "" Then
            fldServedInArmedForcesValidator.ErrorMessage = "Please confirm if you have served in the armed forces"
            fldServedInArmedForcesValidator.IsValid = False
            fldServedInArmedForcesValidator.CssClass = "error alert alert-danger"
            'fldServedInArmedForces.CssClass = "ErrorInput"
            fldServedInArmedForces.Style.Add("border", "1px solid red")
        End If
    ...
    Private Sub btnContinue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnContinue.Click
        ...
        If Me.Page.IsValid Then
            ...
            If fldServedInArmedForces.SelectedValue = "Yes" Then
                WorkingData.EnrolmentRequestRow.ServedInArmedForces = True
            ElseIf fldServedInArmedForces.SelectedValue = "No" Then
                WorkingData.EnrolmentRequestRow.ServedInArmedForces = False
            End If
