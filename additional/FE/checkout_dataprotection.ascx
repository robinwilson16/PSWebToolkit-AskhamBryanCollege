...
<div class="bd-callout bd-callout-askham bd-callout-grey PrivacyNotice">
    ...
    <p>If you have any concerns about the way the College collects or uses your personal data, you should raise your concerns in the first instance with the College’s Data Protection Officer, <a href="mailto:judith.clapham@askham-bryan.ac.uk?Subect=Privacy%20Statement">judith.clapham@askham-bryan.ac.uk</a>. If you are not satisfied with the College's response, you you have the right to complain. See the College's Complaints Policy at <a href="https://www.askham-bryan.ac.uk/publication-scheme-customer-services/" rel="noopener">https://www.askham-bryan.ac.uk/publication-scheme-customer-services/</a> for further details. You also have the right to contact the Information Commissioner's Office at <a href="https://ico.org.uk/" target="_blank" rel="noopener">https://ico.org.uk/</a>.</p>
