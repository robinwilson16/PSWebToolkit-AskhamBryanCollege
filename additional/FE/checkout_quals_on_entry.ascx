...
QCF Certificate at Level 3 which is 30 to 36 credits</td>
 ...
 <h5>Qualifications</h5>
    ...
    <asp:Button runat="server" ID="btnNoQualifications" CssClass="show_hide btn btn-primary" Text="No qualifications" ToolTip="Click to remove all the items listed below (And hide the list)" ClientIDMode="Static" CausesValidation="false"></asp:Button>
    <br />
    <br />
    ...
    <div class="row gap-3">
        <div class="col-md">
            <span class="d-grid gap-2 d-md-block">
                ...
                <cc1:CCCButton ID="btnBack" LinkResource="checkout_enrolments2_FE_aspx" CssClass="d-none" class="d-none" ClientIDMode="Static" runat="server" Text="Back" ImageResource="btnBack" CausesValidation="false" />
            </span>
        </div>
        <div class="col-md text-end">
            <span class="d-grid gap-2 d-md-block">
                <button type="button" class="btn btn-primary btn-lg NextButton">Next </button>
                <cc1:CCCButton ID="btnContinue" LinkResource="checkout_employment_FE_aspx" CssClass="d-none" class="d-none" ClientIDMode="Static" runat="server" Text="Continue" ImageResource="btnContinue" CausesValidation="true" SaveForLater="true" SaveForLaterIn="Request" />
            </span>
        </div>
    </div>
</div>

<%-- <cc1:CCCButton ID="btnBack" runat="server" Text="Back" CssClass="button" LinkResource="checkout_enrolments2_FE_aspx" />
<cc1:CCCButton ID="btnContinue" runat="server" Text="Continue" CssClass="button" LinkResource="checkout_employment_FE_aspx" CausesValidation="true" EnableEnterKey="true" />--%>
<br />
