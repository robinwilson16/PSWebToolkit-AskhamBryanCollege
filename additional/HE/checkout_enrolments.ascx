...
<div class="bd-callout bd-callout-askham bd-callout-grey">
  ...
  <div class="row">
     ...
     <div class="row">
      <div class="col-sm-6 columns form-group">            
                 <cc1:StudentEnrolmentField StudentEnrolmentFieldType="Sex" ID="fldGender" runat="server" IsRequired="true" LabelWidth="300" ClientIDMode="Static" CustomCaption="Legal gender" />
                <asp:CustomValidator ID="fldGenderValidator" runat="server"></asp:CustomValidator>
          </div>
      <div class="col-sm-6 columns form-group">            
                 <cc1:StudentEnrolmentField StudentEnrolmentFieldType="PreferredPronounID" ID="StudentEnrolmentField12" runat="server" ClientIDMode="Static" CustomCaption="Preferred Pronoun" IsRequired="true" />
          </div>
   </div>
</div>
...
<div id="divAddresslines" runat="server" visible="true">
    ...
    <div class="row">
      <div class="col-sm-6 columns form-group"> 
            <cc1:StudentEnrolmentField CustomCaption="Personal Mobile" StudentEnrolmentFieldType="MobileTel" ID="fldMobileTel" runat="server" title="The format of the mobile must be beginning 07, with no spaces and 11 digits in length eg 07771900900" Pattern="^(07[\d]{8,12}|447[\d]{7,11})$"/>
        </div>
      <div class="col-sm-6 columns form-group"> 
      ...
      <div class="row">
        <div class="col-sm-12 columns form-group"> 
             <cc1:StudentEmailField StudentEnrolmentFieldType="Email" ID="fldEmail" runat="server" IsRequired="true"  CustomCaption="Personal Email" Pattern="^[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$"  />
            </div>
       </div>

      <div class="row">
            <div class="col-sm-12 columns form-group"> 
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="AccommodationTypeID" ID="StudentEnrolmentField13" runat="server" IsRequired="true" LabelWidth="400"   CustomCaption="Accommodation during term time" ExcludedIDValues="6,9,10" ClientIDMode="Static" />
        </div>
      </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function (event) {
        ...
        let fldAccommodationTypeID = addSearchableDropDown(cboAccommodationTypeID);
