...
Partial Class checkout_directapply
    ...
    Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
        ...
        If WorkingData.ApplicationRequestRow.Overseas = True Then
            rdoOverseas.SelectedValue = "1"
        End If
        ...
        'ddsen.SelectedValue = "1"
        ' End If

        If WorkingData.EnrolmentRequestRow.HasEducationHealthCarePlan = True Then
            HasEHCP.SelectedValue = "1"
        End If
    ...
    Public Overrides Sub ValidateControl()
        ...
        'If ddsen.SelectedValue = "" Then
        '    Dim a As New CustomValidator
        '    a.IsValid = False
        '    a.ErrorMessage = "Did you receive additional support at school?"
        '    Me.Page.Validators.Add(a)
        '    ddsen.Style.Add("border", "1px solid red")
        'End If

        If rdoCC.SelectedValue = "" Then
            Dim a As New CustomValidator
            a.IsValid = False
            a.ErrorMessage = "Do you have any unspent conditional cautions or convictions?"
            Me.Page.Validators.Add(a)
            rdoCC.Style.Add("border", "1px solid red")
        End If

        If rdoOverseas.SelectedValue = "" Then
            Dim a As New CustomValidator
            a.IsValid = False
            a.ErrorMessage = "Are you applying as an international student?"
            Me.Page.Validators.Add(a)
            rdoOverseas.Style.Add("border", "1px solid red")
        End If

        If NotHECareLeaver.SelectedValue = "" Then
            Dim a As New CustomValidator
            a.IsValid = False
            a.ErrorMessage = "Are you in or have you recently left Local Authority Care?"
            Me.Page.Validators.Add(a)
        ...
        If rdoLearnDiff.SelectedValue = "1" And CType("" & WorkingData.ApplicationRequestRow.DisabilityCategory1ID, String) = "" Then
            Dim a As New CustomValidator
            a.IsValid = False
            a.ErrorMessage = "Please provide your main learning diffculty/disability"
            Me.Page.Validators.Add(a)
            disCat1.Style.Add("border", "1px solid red")
    ...
    Private Sub CheckData()
        ...
        'WorkingData.EnrolmentRequestRow.HasSpecialEducationNeeds = ddsen.SelectedValue
    End Sub
    ...
    Protected Sub btnBack_click(ByVal sender As Object, ByVal e As EventArgs) Handles btnBack.Click
        ...
        If Me.Page.IsValid Then
            ...
            redirectString = GetResourceValue("checkout_directapply2_aspx")
            Response.Redirect(redirectString)
