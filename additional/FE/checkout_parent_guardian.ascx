...
<div class="bd-callout bd-callout-askham bd-callout-grey">
  ...
  <div class="row">
    ...
    <div class="row">
            <div class="col-sm-6 columns form-group">
                <span class="textfieldlabelrequired">Mobile Number</span>
     ...
     <div class="row">
        <div class="col-sm-6 columns form-group">
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="ParentEmailAddress" HTML5InputType="email" ID="fldEmail" runat="server" IsRequired="false" LabelWidth="200" CustomCaption="Email Address" />
        </div>
         <div class="col-sm-6 columns form-group">
    ...
    <div class="row gap-3">
        <div class="col-md">
            <span class="d-grid gap-2 d-md-block">
                ...
                <cc1:CCCButton ID="btnBack" LinkResource="checkout_enrolments_FE_aspx" CssClass="d-none" class="d-none" ClientIDMode="Static" runat="server" Text="Back" ImageResource="btnBack" CausesValidation="false" />
            </span>
        </div>
        <div class="col-md text-end">
            <span class="d-grid gap-2 d-md-block">
                <button type="button" class="btn btn-primary btn-lg NextButton">Next </button>
                <cc1:CCCButton ID="btnContinue" LinkResource="checkout_enrolments2_FE_aspx" CssClass="d-none" class="d-none" ClientIDMode="Static" runat="server" Text="Continue" ImageResource="btnContinue" CausesValidation="true" SaveForLater="true" SaveForLaterIn="Request" />
            </span>
        </div>
    </div>
</div>
