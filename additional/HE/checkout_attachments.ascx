        ...
        <div id="UploadWarning" class="alert alert-warning hstack gap-3 d-none" role="alert">
            <div>
                ...
                <div>
                    ...
                    <ul>
                        <li>
                            Email a photograph of your ID and Certificates to <a href="mailto:he@askham-bryan.ac.uk?subject=Cannot Upload Evidence">he@askham-bryan.ac.uk</a>. Please include your <strong>full name</strong> in the subject line.
                        </li>
                        <li>
    ...
    <div class="row gap-3">
        ...
        <div class="col-md text-end">
            <span class="d-grid gap-2 d-md-block">
                ...
                <cc1:CCCButton ID="btnContinue" LinkResource="checkout_photo_HE_aspx" CssClass="d-none" class="d-none" ClientIDMode="Static" runat="server" Text="Continue" ImageResource="btnContinue" CausesValidation="true" SaveForLater="true" SaveForLaterIn="Request" />
            </span>
        </div>
    </div>
</div>
...
<cc1:CCCButton ID="btnContinue" runat="server" Text="Continue" CssClass="button"  LinkResource="checkout_photo_HE_aspx" CausesValidation="true" />--%>
