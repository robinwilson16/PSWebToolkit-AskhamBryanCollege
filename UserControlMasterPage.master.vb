...
Partial Class UserControlMasterPage
    ...
    Private Sub LoadLinks()
        ...
        Dim css7 As New HtmlGenericSelfClosing()
        css7.TagName = "link"
        css7.Attributes.Add("rel", "stylesheet")
        css7.Attributes.Add("type", "text/css")
        css7.Attributes("href") = ResolveUrl("~/content/abc.css")
        htmlHeader.Controls.Add(css7)
        ...
        Dim js8 As New HtmlGenericControl("script")
        js8.Attributes("type") = "text/javascript"
        js8.Attributes("src") = ResolveUrl("https://cdn.getaddress.io/scripts/getaddress-autocomplete-native-1.0.2.min.js")
        htmlHeader.Controls.Add(js8)

        Dim js9 As New HtmlGenericControl("script")
        js9.Attributes("type") = "text/javascript"
        js9.Attributes("src") = ResolveUrl("~/Scripts/abc.js")
        htmlHeader.Controls.Add(js9)
